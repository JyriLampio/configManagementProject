...
My task was to Deploy Django 4 Production installation as a salt state. 
...
I run the init.sls file again on the new virtual machine. Everything went through okay. Then I restarted apache:
